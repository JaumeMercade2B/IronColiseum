...
public class FPSController : MonoBehaviour
{
    ...
    public Volume lifeVolume;

    public bool lifeLevel2;
    public bool shieldLevel2;
    ...
    void FixedUpdate()
    {
        ...
        if (canDash && levelManager.canAct == true)
        {
        ...
        if (life <= maxLife / 2 && shield <= 0)
        {
            lifeVolume.weight = 1 - (life / maxLife); 
        }
        ...
        {
            lifeVolume.weight -= 0.5f;

            if (lifeVolume.weight <= 0)
            {
                lifeVolume.weight = 0;
            }
        }
    ...
    public void Move()
    {
        ...
        transform.Translate(lastDirection * frenada * Time.deltaTime);
    ...
    private void FixedUpdateJump()
    {
        ...
        if (jump && levelManager.canAct == true)
        {
    ...
    public void ShootMisil()
    {
        ...
        if (manager.pause == false && levelManager.canAct == true)
        {
    ...
    public void LiveLevel3()
    {
        maxLife = 20;
        life = maxLife;
    }

    public void ShieldLevel3()
    {
        maxShield = 12;
        shield = maxShield;
    }
